...
document.addEventListener('DOMContentLoaded',function () {
    ...
    //  ================= ORDER SUMMARY AND TOTAL ORDER LOGIC ====================
     function renderordersummary(){
        ...
        for(const cards of card_size){
             ...
             let qty = 0
             if (qty_input){
              qty = parseInt(qty_input.value) || 1
             }
             ...
             if (qty>0){
                 ...
                 summaryhtml += `
                          <div class="grid grid-cols-12 text-[11px] text-slate-300 items-center text-center py-1 border-b border-slate-800/40">
                            ...
                            <span class="col-span-3 text-right font-semibold text-emerald-400">৳${price.toFixed(2)}</span>
                          </div>
                        `}
              }
 ...
 // =============== PRODUCT LIST CAHK VAREABOL ============
            // const btn_plus =cards.querySelector('.btn-plus')
            // const btn_mainus = cards.querySelector('.btn-mainus')
            // const qty_input = cards.querySelector('.qty-input')
            // const condtion = cards.dataset.selected

            // if (condtion === 'false'){
               
            //     cards.dataset.selected = "true"
            //     btn_plus.addEventListener('click',function(){
            //         total_product ++

            //     })
            //   btn_mainus.addEventListener('click',function(){
            //     total_product --
            //   })
            //   qty_input.addEventListener('click',function(){
            //     const user_value = parseInt( qty_input.value) || 0
            //     if (user_value >= 0){
            //         total_product = 50
            //     }
            //     else{
            //         total_product = user_value
            //     }
            ...
            //                 <span class="col-span-5 text-left font-medium text-slate-200 truncate">${name}</span>
            //                 <span class="col-span-2">৳${price.toFixed(2)}</span>
            //                 <span class="col-span-2">${total_product}</span>
            //                 <span class="col-span-3 text-right font-semibold text-emerald-400">৳${price.toFixed(2)}</span>
            //               </div>
            //             `
